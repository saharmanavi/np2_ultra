...
pathToYourConfigFile = '\\10.128.54.155\Data\kilosort_files'; % take from Github folder and put it somewhere else (together with the master_file)
chanMapFile = 'kilosort_chanMap_ultra.mat';


ops.trange = [0 Inf]; % time range to sort
ops.NchanTOT    = 384; % total number of channels in your recording

run(fullfile(pathToYourConfigFile, 'kilosort_config_ultra.m'))
